...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- favicon -->
        <link rel="shortcut icon" href="images/aelyon.png">
    ...
    <body>
        ...
        <section id="home" class="no-padding">
            <div id="owl-demo" class="owl-carousel owl-theme light-pagination square-pagination dark-pagination-without-next-prev-arrow main-slider">
                ...
                <!-- end slider item -->
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('images/programming-4.jpg');">
                    <div class="opacity-full bg-dark-gray"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography text-center">
                            <div class="slider-text-middle-main">
                ...
                <!-- end slider item -->
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('images/programming-5.jpg');">
                    <div class="opacity-full bg-dark-gray"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography text-center">
                            <div class="slider-text-middle-main">
        ...
        <section id="portfolio" class="grid-wrap work-4col margin-top-section no-margin-top no-padding-bottom wow fadeIn">
            <div class="container">
                <div class="row">
                    ...
                    <!-- end section title -->
                    <div class="col-md-2 col-md-offset-2 col-sm-10 margin-three left-col text-center">
                    ...
                    <div class="col-md-6 col-sm-10 margin-one margin-three-bottom text-right right-col">
                        <img src="images/vector-2-400px.jpg" alt="">
                    </div>
                </div>
            </div>
        ...
        <!-- highlight section -->
        <section class="bg-dark-blues no-padding wow fadeInUp">
            <div class="container">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-md-12 col-sm-12 center-col text-center no-padding" id="animated-tab">
                        ...
                        <ul class="nav nav-tabs margin-five no-margin-top xs-margin-bottom-seven">
                            <li class="nav active"><a href="#tab6_sec1" data-toggle="tab" class="xs-min-height-inherit xs-no-padding"><span><i class="icon-notebook"></i></span></a><br><span class="text-small text-uppercase letter-spacing-3 margin-five font-weight-600 xs-letter-spacing-none xs-display-none">Enterprise</span><br><span class="text-small text-uppercase letter-spacing-3 margin-five font-weight-600 xs-letter-spacing-none xs-display-none">solution</span></li>
                            ...
                            <div id="tab6_sec1" class="text-center center-col tab-pane fade in active"> 
                                <div class="tab-pane fade in"> 
                                    ...
                                    <div class="col-lg-6 col-md-6 corporate-standards-text sm-margin-lr-four sm-margin-top-four xs-padding-tb-ten">
                                        ...
                                        <i class="icon-notebook medium-icon yellow-text"></i>
            ...
            <div class=" bg-white footer-top">
                <div class="container">
                    <div class="row margin-four">
                        <!-- phone -->
                        <div class="col-md-4 col-sm-4 text-center"><i class="icon-phone small-icon black-text"></i><h6 class="black-text margin-two no-margin-bottom">(0778) 467883 , 081267908009</h6></div>
                        <!-- end phone -->
                        <!-- address -->
